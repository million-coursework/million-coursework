...
For our project, all the resources of codes and how it works are from our client. Another helpful resource for us is that our client could help us to get in touch with CECS，and CECS could help us to do the testing. we would also get feedbacks from the testing. Then, for the could service, we plan to use one of the three services in the budget table below. 
